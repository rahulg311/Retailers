...
<div class="collapse navbar-collapse" id="navbarSupportedContent">
  <ul class="navbar-nav mr-auto">
    <li class="nav-item active">
      <a class="nav-link" href="/AuditHome">Home <span class="sr-only">(current)</span></a>
    </li>
    <li class="nav-item">
      <a class="nav-link" href="/AuditKycreqs">KYC Reqs.</a>
    </li>
    <li class="nav-item">
      <a class="nav-link" href="/AuditVeryfied">Verified</a>
    </li>
    <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          <a class="dropdown-item" href="#">Pending Kyc</a>
          <a class="dropdown-item" href="#">Total Users</a>
          <div class="dropdown-divider"></div>
          <a class="dropdown-item" href="#">Rejected Kyc</a>
        </div>
      </li>
  </ul>
