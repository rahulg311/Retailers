...
function AuditVeryfied() {
  ...
  return (
    <>
<AuditHeader/>
<p class="font-weight-normal mt-1 text-center col-md-3 col-12"  style={{backgroundColor:"skyblue"}}>Veryfied Users</p>
